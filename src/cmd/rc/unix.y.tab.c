...
#line	13	"/usr/glenda/p9/src/cmd/rc/syn.y"
#include "rc.h"
#include "fns.h"

#line	16	"/usr/glenda/p9/src/cmd/rc/syn.y"
typedef union {
	struct tree *tree;
} YYSTYPE;
...
case 1:
#line	24	"/usr/glenda/p9/src/cmd/rc/syn.y"
{ return 1;} break;
case 2:
#line	25	"/usr/glenda/p9/src/cmd/rc/syn.y"
{return !compile(yypt[-1].yyv.tree);} break;
case 4:
#line	27	"/usr/glenda/p9/src/cmd/rc/syn.y"
{yyval.tree=tree2(';', yypt[-1].yyv.tree, yypt[-0].yyv.tree);} break;
case 6:
#line	29	"/usr/glenda/p9/src/cmd/rc/syn.y"
{yyval.tree=tree2(';', yypt[-1].yyv.tree, yypt[-0].yyv.tree);} break;
case 8:
#line	31	"/usr/glenda/p9/src/cmd/rc/syn.y"
{yyval.tree=tree1('&', yypt[-1].yyv.tree);} break;
case 11:
#line	34	"/usr/glenda/p9/src/cmd/rc/syn.y"
{yyval.tree=tree1(BRACE, yypt[-1].yyv.tree);} break;
case 12:
#line	35	"/usr/glenda/p9/src/cmd/rc/syn.y"
{yyval.tree=tree1(PCMD, yypt[-1].yyv.tree);} break;
case 13:
#line	36	"/usr/glenda/p9/src/cmd/rc/syn.y"
{yyval.tree=tree2('=', yypt[-2].yyv.tree, yypt[-0].yyv.tree);} break;
case 14:
#line	37	"/usr/glenda/p9/src/cmd/rc/syn.y"
{yyval.tree=0;} break;
case 15:
#line	38	"/usr/glenda/p9/src/cmd/rc/syn.y"
{yyval.tree=mung2(yypt[-1].yyv.tree, yypt[-1].yyv.tree->child[0], yypt[-0].yyv.tree);} break;
case 16:
#line	39	"/usr/glenda/p9/src/cmd/rc/syn.y"
{yyval.tree=mung1(yypt[-1].yyv.tree, yypt[-1].yyv.tree->rtype==HERE?heredoc(yypt[-0].yyv.tree):yypt[-0].yyv.tree);} break;
case 18:
#line	41	"/usr/glenda/p9/src/cmd/rc/syn.y"
{yyval.tree=0;} break;
case 19:
#line	42	"/usr/glenda/p9/src/cmd/rc/syn.y"
{yyval.tree=epimung(yypt[-1].yyv.tree, yypt[-0].yyv.tree);} break;
case 20:
#line	43	"/usr/glenda/p9/src/cmd/rc/syn.y"
{skipnl();} break;
case 21:
#line	44	"/usr/glenda/p9/src/cmd/rc/syn.y"
{yyval.tree=mung2(yypt[-3].yyv.tree, yypt[-2].yyv.tree, yypt[-0].yyv.tree);} break;
case 22:
#line	45	"/usr/glenda/p9/src/cmd/rc/syn.y"
{skipnl();} break;
case 23:
#line	45	"/usr/glenda/p9/src/cmd/rc/syn.y"
{yyval.tree=mung1(yypt[-2].yyv.tree, yypt[-0].yyv.tree);} break;
case 24:
#line	46	"/usr/glenda/p9/src/cmd/rc/syn.y"
{skipnl();} break;
case 25:
#line	55	"/usr/glenda/p9/src/cmd/rc/syn.y"
...
case 26:
#line	56	"/usr/glenda/p9/src/cmd/rc/syn.y"
{skipnl();} break;
case 27:
#line	57	"/usr/glenda/p9/src/cmd/rc/syn.y"
{yyval.tree=mung3(yypt[-5].yyv.tree, yypt[-3].yyv.tree, (struct tree *)0, yypt[-0].yyv.tree);} break;
case 28:
#line	58	"/usr/glenda/p9/src/cmd/rc/syn.y"
{skipnl();} break;
case 29:
#line	59	"/usr/glenda/p9/src/cmd/rc/syn.y"
{yyval.tree=mung2(yypt[-3].yyv.tree, yypt[-2].yyv.tree, yypt[-0].yyv.tree);} break;
case 30:
#line	60	"/usr/glenda/p9/src/cmd/rc/syn.y"
{skipnl();} break;
case 31:
#line	61	"/usr/glenda/p9/src/cmd/rc/syn.y"
{yyval.tree=tree2(SWITCH, yypt[-2].yyv.tree, yypt[-0].yyv.tree);} break;
case 32:
#line	62	"/usr/glenda/p9/src/cmd/rc/syn.y"
{yyval.tree=simplemung(yypt[-0].yyv.tree);} break;
case 33:
#line	63	"/usr/glenda/p9/src/cmd/rc/syn.y"
{yyval.tree=mung2(yypt[-2].yyv.tree, yypt[-1].yyv.tree, yypt[-0].yyv.tree);} break;
case 34:
#line	64	"/usr/glenda/p9/src/cmd/rc/syn.y"
{yyval.tree=tree2(ANDAND, yypt[-2].yyv.tree, yypt[-0].yyv.tree);} break;
case 35:
#line	65	"/usr/glenda/p9/src/cmd/rc/syn.y"
{yyval.tree=tree2(OROR, yypt[-2].yyv.tree, yypt[-0].yyv.tree);} break;
case 36:
#line	66	"/usr/glenda/p9/src/cmd/rc/syn.y"
{yyval.tree=mung2(yypt[-1].yyv.tree, yypt[-2].yyv.tree, yypt[-0].yyv.tree);} break;
case 37:
#line	67	"/usr/glenda/p9/src/cmd/rc/syn.y"
{yyval.tree=mung2(yypt[-1].yyv.tree, yypt[-1].yyv.tree->child[0], yypt[-0].yyv.tree);} break;
case 38:
#line	68	"/usr/glenda/p9/src/cmd/rc/syn.y"
{yyval.tree=mung3(yypt[-1].yyv.tree, yypt[-1].yyv.tree->child[0], yypt[-1].yyv.tree->child[1], yypt[-0].yyv.tree);} break;
case 39:
#line	69	"/usr/glenda/p9/src/cmd/rc/syn.y"
{yyval.tree=mung1(yypt[-1].yyv.tree, yypt[-0].yyv.tree);} break;
case 40:
#line	70	"/usr/glenda/p9/src/cmd/rc/syn.y"
{yyval.tree=mung1(yypt[-1].yyv.tree, yypt[-0].yyv.tree);} break;
case 41:
#line	71	"/usr/glenda/p9/src/cmd/rc/syn.y"
{yyval.tree=tree2(FN, yypt[-1].yyv.tree, yypt[-0].yyv.tree);} break;
case 42:
#line	72	"/usr/glenda/p9/src/cmd/rc/syn.y"
{yyval.tree=tree1(FN, yypt[-0].yyv.tree);} break;
case 44:
#line	74	"/usr/glenda/p9/src/cmd/rc/syn.y"
{yyval.tree=tree2(ARGLIST, yypt[-1].yyv.tree, yypt[-0].yyv.tree);} break;
case 45:
#line	75	"/usr/glenda/p9/src/cmd/rc/syn.y"
{yyval.tree=tree2(ARGLIST, yypt[-1].yyv.tree, yypt[-0].yyv.tree);} break;
case 47:
#line	77	"/usr/glenda/p9/src/cmd/rc/syn.y"
{yyval.tree=tree2('^', yypt[-2].yyv.tree, yypt[-0].yyv.tree);} break;
case 48:
#line	78	"/usr/glenda/p9/src/cmd/rc/syn.y"
{lastword=1; yypt[-0].yyv.tree->type=WORD;} break;
case 50:
#line	80	"/usr/glenda/p9/src/cmd/rc/syn.y"
{yyval.tree=tree2('^', yypt[-2].yyv.tree, yypt[-0].yyv.tree);} break;
case 51:
#line	81	"/usr/glenda/p9/src/cmd/rc/syn.y"
{yyval.tree=tree1('$', yypt[-0].yyv.tree);} break;
case 52:
#line	82	"/usr/glenda/p9/src/cmd/rc/syn.y"
{yyval.tree=tree2(SUB, yypt[-3].yyv.tree, yypt[-1].yyv.tree);} break;
case 53:
#line	83	"/usr/glenda/p9/src/cmd/rc/syn.y"
{yyval.tree=tree1('"', yypt[-0].yyv.tree);} break;
case 54:
#line	84	"/usr/glenda/p9/src/cmd/rc/syn.y"
{yyval.tree=tree1(COUNT, yypt[-0].yyv.tree);} break;
case 56:
#line	86	"/usr/glenda/p9/src/cmd/rc/syn.y"
{yyval.tree=tree1('`', yypt[-0].yyv.tree);} break;
case 57:
#line	87	"/usr/glenda/p9/src/cmd/rc/syn.y"
{yyval.tree=tree1(PAREN, yypt[-1].yyv.tree);} break;
case 58:
#line	88	"/usr/glenda/p9/src/cmd/rc/syn.y"
{yyval.tree=mung1(yypt[-1].yyv.tree, yypt[-0].yyv.tree); yyval.tree->type=PIPEFD;} break;
case 69:
#line	90	"/usr/glenda/p9/src/cmd/rc/syn.y"
{yyval.tree=(struct tree*)0;} break;
case 70:
#line	91	"/usr/glenda/p9/src/cmd/rc/syn.y"
