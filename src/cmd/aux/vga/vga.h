...
typedef struct Mode Mode;	// HK 20090930
...
struct Ctlr {
	...
	void	(*load)(Vga*, Ctlr*);
	void	(*dump)(Vga*, Ctlr*);
	void	(*loadtext)(Vga *, Ctlr *);	// HK 20090930
	char*	(*probe)(Vga *, Ctlr *);	// HK 20090930
	Mode*	(*dbmode)(char *, char *, char *);		// HK 20090930
	ulong	flag;
...
enum {					/* flag */
	...
	Avesalinear	= 0x01000000, /* use Algorithm VESA-type linear timming */	// HK 20090930
};
...
/* pci.c */
//typedef struct Pcidev Pcidev;	// HK 20090831
