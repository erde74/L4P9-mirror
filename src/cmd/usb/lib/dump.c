...
void
pdevice(Device * _x, int _y, ulong _z, void *b, int n)
{
	DDevice *d;
...
void
phid(Device * _x, int _y, ulong _z, void *b, int n)
{
	DHid *d;
...
void
preport(Device * _x, int _y, ulong _z, byte *b, int n)
{
	byte *s, *es;
	int tag, nb, i, indent;
	int v;
...
void
phub(Device * _x, int _y, ulong _z, void *b, int n)
{
	DHub *d;
...
void
pstring(Device * _x, int _y, ulong _z, void *b, int n)
{
	byte *rb;
	char *s;
	Rune r;
...
static void
pcs_config(Device * _x, int _y, ulong _z, void *b, int n)
{
	pcs_raw("CS_CONFIG", b, n);
}

static void
pcs_string(Device * _x, ulong _y, void *b, int n)
{
	pcs_raw("CS_STRING", b, n);
}

static void
pcs_endpoint(Device * _x, int _y, ulong _z, void *bb, int n)
{
	byte *b = bb;
...
static void
pcs_interface(Device * _x, int n, ulong _y, void *bb, int nb) {
...
pdesc(Device *d, int c, ulong csp, byte *b, int n)
{
	...
	if (c >= (int)nelem(d->config)) {            //% (int) is added.
