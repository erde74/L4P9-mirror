...
bootdump(int fd, Dosboot *b)
{
  ...
  DBGPRN("> %s() \n", __FUNCTION__);
	...
	Binit(&bp, fd, OWRITE);
	Bprint(&bp._Biobufhdr, "magic: 0x%2.2x 0x%2.2x 0x%2.2x\n",
	       b->magic[0], b->magic[1], b->magic[2]);  //%
	Bprint(&bp._Biobufhdr, "version: \"%8.8s\"\n", (char*)b->version);  //%
	Bprint(&bp._Biobufhdr, "sectsize: %d\n", GSHORT(b->sectsize));
	Bprint(&bp._Biobufhdr, "clustsize: %d\n", b->clustsize);
	Bprint(&bp._Biobufhdr, "nresrv: %d\n", GSHORT(b->nresrv));
	Bprint(&bp._Biobufhdr, "nfats: %d\n", b->nfats);
	Bprint(&bp._Biobufhdr, "rootsize: %d\n", GSHORT(b->rootsize));
	Bprint(&bp._Biobufhdr, "volsize: %d\n", GSHORT(b->volsize));
	Bprint(&bp._Biobufhdr, "mediadesc: 0x%2.2x\n", b->mediadesc);
	Bprint(&bp._Biobufhdr, "fatsize: %d\n", GSHORT(b->fatsize));
	Bprint(&bp._Biobufhdr, "trksize: %d\n", GSHORT(b->trksize));
	Bprint(&bp._Biobufhdr, "nheads: %d\n", GSHORT(b->nheads));
	Bprint(&bp._Biobufhdr, "nhidden: %ld\n", GLONG(b->nhidden));
	Bprint(&bp._Biobufhdr, "bigvolsize: %ld\n", GLONG(b->bigvolsize));
	Bprint(&bp._Biobufhdr, "driveno: %d\n", b->driveno);
	Bprint(&bp._Biobufhdr, "reserved0: 0x%2.2x\n", b->reserved0);
	Bprint(&bp._Biobufhdr, "bootsig: 0x%2.2x\n", b->bootsig);
	Bprint(&bp._Biobufhdr, "volid: 0x%8.8lux\n", GLONG(b->volid));
	Bprint(&bp._Biobufhdr, "label: \"%11.11s\"\n", (char*)b->label);
	Bterm(&bp);
#endif //----------------------------
}
...
bootdump32(int fd, Dosboot32 *b)
{
  ...
  DBGPRN("> %s() \n", __FUNCTION__);
	...
	Bprint(&bp._Biobufhdr, "nhidden: %ld\n", GLONG(b->nhidden));
	Bprint(&bp._Biobufhdr, "bigvolsize: %ld\n", GLONG(b->bigvolsize));
	Bprint(&bp._Biobufhdr, "fatsize32: %ld\n", GLONG(b->fatsize32));
	Bprint(&bp._Biobufhdr, "extflags: %d\n", GSHORT(b->extflags));
	Bprint(&bp._Biobufhdr, "version: %d\n", GSHORT(b->version1));
	Bprint(&bp._Biobufhdr, "rootstart: %ld\n", GLONG(b->rootstart));
	Bprint(&bp._Biobufhdr, "infospec: %d\n", GSHORT(b->infospec));
	Bprint(&bp._Biobufhdr, "backupboot: %d\n", GSHORT(b->backupboot));
	Bprint(&bp._Biobufhdr, "reserved: %d %d %d %d %d %d %d %d %d %d %d %d\n",
