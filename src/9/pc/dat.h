...
// typedef struct MapArea MapArea_t;
//
// struct MapArea {
//   L4_Fpage_t  fpage;
//   uint        adrs;
...
struct Clerkjob {
    unsigned        stk[3000-4-1-1-1-1-1-8-128-32]; //No special meanig.
    unsigned        stktop[2];
    //- - - - - - - - -
    L4_Fpage_t      mappee; // my-side <- mapped into
    L4_Fpage_t      mapper; // client-side
    Clerkjob_t       *next;
    L4_ThreadId_t   tid;
...
extern Clerkjob_t   cjob;  //defined in proc-l4.c
