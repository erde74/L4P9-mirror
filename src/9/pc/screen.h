...
struct VGAdev {
	...
	long (*drvctlread)(VGAscr *scr, void *a, long n, vlong off);	// HK 20090930
	long (*drvctlwrite)(VGAscr *scr, void *a, long n, vlong off);	// HK 20090930
};
...
//	ulong	paddr;		/* frame buffer */	// HK 20090930
	void*	vaddr;
	int	apsize;
...
extern Memimage *gscreen;	// HK 20090831
