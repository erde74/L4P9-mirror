...
#if 1 //%--------NOW in milli-second ? -----------
#define	NOW	(microsectime()/1000ULL)
#else //plan9--------------
...
extern int	ipifcremmulti(Conv *c, uchar *ma, uchar *ia); //% ONERR <- void 
extern int	ipifcaddmulti(Conv *c, uchar *ma, uchar *ia); //% ONERR <- void
