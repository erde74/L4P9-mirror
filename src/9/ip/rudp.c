...
relstate(Rudpcb *ucb, uchar *addr, ushort port, char *from)
{
	...
	if(r == nil){
		...
		r->xmits = 0;
		r->timeout = 0;
		r->_ref.ref = 0;	//% ref -> _ref
		incref(&r->_ref);	/* one reference for being in the list */ //% _ref
