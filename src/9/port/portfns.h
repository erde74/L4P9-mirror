...
//%start  LP49 simple err-handler ----------------------------------
#define		poperror()	

//% Cf. original ------------------------
//#define   poperror()	up->nerrlab--
//#define   poperror()  (l4printf("$[%d-]%s ", up->nerrlab, __FUNCTION__), up->nerrlab--)

void     nexterror_in(const char*);
#define  nexterror()  nexterror_in(__FUNCTION__)

void	 error_in(const char* msg, const char* func);	// HK 20091031
#define  error(x)   error_in(x, __FUNCTION__)
...
Chan* 	        devcreate(Chan*, char*, int, ulong); //% <- void
...
int		devpermcheck(char*, ulong, int);   //% <- void
int		devpower(int);   //% <- void
int		devremove(Chan*); //% <- void
void		devreset(void); 
...
Proc*		newproc(void);
//% void		nexterror(void);
void     nexterror_in(const char*);   //%	// HK 20091031
int		notify(Ureg*);
int		nrand(int);
...
int /*void*/	pathclose(Path*);  //% ONERR
ulong		perfticks(void);
void		pexit(char*, int);
void		pgrpcpy(Pgrp*, Pgrp*);
int /*void*/	pgrpnote(ulong, char*, long, int);   //% ONERR
...
int 		tsleep(Rendez*, int (*)(void*), void*, ulong); //%? ONERR <- void
